...
import TransicationReceipt from '../Stack/Transication/TransicationReceipt';
import Advance from '../Stack/Transication/Advance';
import Payment from '../Stack/Transication/Payment';
import Loan from '../Stack/Transication/Loan';
            ...
            <View>
                <View style={styles.navbar}>
                    <TouchableOpacity onPress={() => handleTabChange(1)} style={[styles.tab, selectedTab === 1 && styles.activeTab]}>
                        <Text style={styles.tabText}>Transication</Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity onPress={() => handleTabChange(4)} style={[styles.tab, selectedTab === 4 && styles.activeTab]}>
                        <Text style={styles.tabText}>Loan</Text>
                    </TouchableOpacity>
                </View>
                {selectedTab === 1 ? <TransicationReceipt driverData={driverData} navigation={navigation} /> :
                    selectedTab === 2 ? <Advance driverData={driverData} navigation={navigation} /> :
                        selectedTab === 3 ? <Payment driverData={driverData} navigation={navigation} /> :
                        selectedTab === 4 ? <Loan driverData={driverData} navigation={navigation} /> :
                            null}
            </View>
        </View>
    );
